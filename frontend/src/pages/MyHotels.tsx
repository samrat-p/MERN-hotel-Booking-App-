...
import { BsBuildingCheck, BsMap } from "react-icons/bs";
import { BiMoney, BiSolidHotel, BiSolidStar } from "react-icons/bi";
        ...
        {hotelData.map((hotel) => (
          <div className="flex flex-col justify-between border border-slate-300 rounded-lg p-8 gap-5">
            ...
            <div className="grid grid-cols-5 gap-2">
              ...
              <div className="border border-slate-300 rounded-sm p-3 flex items-center">
                <BsBuildingCheck className="mr-2" />
                {hotel.type}
              </div>
              <div className="border border-slate-300 rounded-sm p-3 flex items-center">
              ...
              <div className="border border-slate-300 rounded-sm p-3 flex items-center">
                <BiSolidHotel className="mr-2" />
                {hotel.adultCount} Adults, {hotel.childCount} Childs
              </div>
              <div className="border border-slate-300 rounded-sm p-3 flex items-center">
                <BiSolidStar className="mr-2" />
